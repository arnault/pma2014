...
private void launchSoundIntent() {
	...
	private void launchCameraIntent() {
		...
		fragment.imagePath = Uri.fromFile(getOutputMediaFile(MEDIA_TYPE_IMAGE)); 

		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		i.putExtra(MediaStore.EXTRA_OUTPUT, fragment.imagePath);
	...
	private void launchVideoCameraIntent() {
		...
		// TODO - Add the filename to the Intent as an extra. Use the Intent-extra name
		// from the MediaStore class, EXTRA_OUTPUT
		i.putExtra(MediaStore.EXTRA_OUTPUT, fragment.fileUri);
		...
		startActivityForResult(i, CAMERA_VIDEO_REQUEST);
